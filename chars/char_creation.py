...
def create_char():
    ...
    input_slow(
        "You can choose your starting weapon from this list:battleaxe, scimitar, sickle:"
    )
    weap_choose = input()
    ...
    print_slow(
        f"Your damage is {player.damage[0]}d{player.damage[1]}+{player.damage[2]} "
    )
    ...
    print_slow(
        "You heard a whisper in your head:You can't go back, try to survive.*laughing*"
    )
